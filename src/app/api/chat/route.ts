...
export async function POST(req: Request) {
  try {
    ...
    const FALLBACK_MESSAGE = "სამწუხაროდ, ამ საკითხზე ზუსტი ინფორმაცია არ მაქვს. შეგიძლიათ დაუკავშირდეთ ჩვენს მხარდაჭერის გუნდს ნომერზე 551 50 06 06, მოგვწეროთ ელ.ფოსტაზე info@ninika.ge, ან ისარგებლოთ საიტზე არსებული მესენჯერის ღილაკით.";
