...
4. შეკვეთის გაფორმებაზე ან კონტაქტზე კითხვისას: აუხსენი მომხმარებელს, რომ შეკვეთის განთავსება შეუძლიათ საიტზე (ninika.ge), ან პირდაპირ დარეკონ ნომერზე: 551 50 06 06.
